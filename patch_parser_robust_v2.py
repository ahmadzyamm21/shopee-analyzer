...
# 2. Update incomeGroup mappings
pattern_income = r'incomeGroup\[id\]\.payout\s*\+=\s*parseNumber\(row\[\'Total Penghasilan\'\]\);[\s\S]*?incomeGroup\[id\]\.voucherCofund\s*\+=\s*parseNumber\(row\[\'Voucher co-fund disponsor oleh Penjual\'\]\);'
...
print("Patcher script v2 finished.")
